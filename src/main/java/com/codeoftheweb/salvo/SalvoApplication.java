...
public class SalvoApplication {
    ...
    public CommandLineRunner initData(PlayerRepository playerRepository, GameRepository gameRepository, GamePlayerRepository gamePlayerRepository, ShipRepository shipRepository) {
        return (args) -> {
            ...
            Ship ship24 = new Ship("Destroyer", gamePlayer13, Arrays.asList("B5", "C5", "D5"));
            Ship ship25 = new Ship("Patrol Boat", gamePlayer13, Arrays.asList("C6", "C7"));
            Ship ship26 = new Ship("Submarine", gamePlayer14, Arrays.asList("A2", "A3", "A4"));
            Ship ship27 = new Ship("Patrol Boat", gamePlayer14, Arrays.asList("G6", "H6"));
